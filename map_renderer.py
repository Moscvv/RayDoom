...
class MapRenderer:
    def __init__(self, engine):
        ...
        # calling the raw segments from level_data.py
    ...
    def draw(self):
        #drawing original and new segments
    ...
    def draw_player(self, dist=100):
        ...
        #
        draw_line_v((x0, y0), (x1, y1), WHITE)
        draw_circle_v((x0, y0), 10, GREEN)

    def draw_segments(self, seg_color=ORANGE):
    ...
    def draw_normal(self, p0, p1, color, scale=10):
            ...
            n1 = n0 + normal * scale
            #
            draw_line_v((n0.x, n0.y), (n1.x, n1.y), color)
